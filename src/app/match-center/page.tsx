  ...
  return (
    <main className="mx-auto max-w-7xl p-6">
      <div className="mb-6 rounded-sm border border-crimson/40 bg-card p-6">
        <div className="text-xs font-mono font-bold tracking-wider text-crimson uppercase">THE MAPLE PITCH // MATCH CENTER</div>
        <h1 className="mt-2 text-4xl font-black text-charcoal">MATCH CENTER</h1>
        ...
        {PLACEHOLDER_MATCHES.map((match) => {
          ...
          return (
            ...
            >
              ...
              <div className="mt-2 text-xs font-mono text-crimson">Open match center →</div>
            </Link>
          );
        })}
      </div>
