      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <aside className="space-y-6">
          <div className="border border-border bg-card p-5">
            {playerPhoto ? (
              <div className="mb-4 flex h-32 w-32 overflow-hidden border border-border/60 bg-neutral-900/5 p-1 rounded-sm">
                <Image
                  src={playerPhoto}
              ...
              <div className="mb-4 flex h-32 w-32 items-center justify-center border border-border/60 bg-neutral-900/10 text-xs font-mono font-bold text-crimson">
                [{player.name ? player.name.substring(0, 3).toUpperCase() : 'ATH'}]
              </div>
            )}
