...
export default function StatsHubPage() {
  ...
  const [mlsStandings, setMlsStandings] = useState<StandingsRow[]>([]);
  const [nwslStandings, setNwslStandings] = useState<StandingsRow[]>([]);
  ...
  useEffect(() => {
    ...
    getMlsStandings(Number(season)).then((data) => {
      if (data) setMlsStandings(data);
    });
    getNwslStandings(Number(season)).then((data) => {
      if (data) setNwslStandings(data);
    });
  }, [season]);
