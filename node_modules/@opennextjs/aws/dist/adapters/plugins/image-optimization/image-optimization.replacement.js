...
export async function optimizeImage(headers, imageParams, nextConfig, handleRequest) {
    ...
    const callFetchInternalImage = () => {
        ...
        return fetchInternalImage(href, { headers }, {}, // res object is not necessary as it's not actually used.
        handleRequest);
    };
